...
The client code for the preceding server::
   ...
   with xmlrpc.client.ServerProxy("http://lisyoen2.iptime.org:8000/") as proxy:
...
The client code for the preceding server::
   ...
   proxy = xmlrpc.client.ServerProxy("http://lisyoen2.iptime.org:8000/")
...
::
   ...
   # server = ServerProxy("http://lisyoen2.iptime.org:8000") # local server
